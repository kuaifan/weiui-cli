...
function changeSetting(op, add) {
    let path = process.cwd();
    path += dirCut + 'platforms' + dirCut + 'android' + dirCut + 'WeiuiApp' + dirCut + 'settings.gradle';
...
function changeGradle(op, add) {
    let path = process.cwd();
    path += dirCut + 'platforms' + dirCut + 'android' + dirCut + 'WeiuiApp' + dirCut + 'app' + dirCut + 'build.gradle';
    let result = fs.readFileSync(path, 'utf8');
